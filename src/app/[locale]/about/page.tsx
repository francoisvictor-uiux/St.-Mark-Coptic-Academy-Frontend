...
export default async function AboutPage({
  ...
  // CMS-managed when a published page with slug "about" exists; otherwise the
  // "Coming Soon" placeholder ships until the About Us content is authored.
  const page = await getPageBySlug("about");
  if (!page) return <ComingSoon title={t("about")} />;
